...
class ViewController: UIViewController, PKToolPickerObserver, ImagePickerDelegate, VideoPickerDelegate {
    ...
    override func viewWillTransition(to size: CGSize, with coordinator: UIViewControllerTransitionCoordinator) {
        ...
        coordinator.animate(alongsideTransition: nil) { _ in
            ...
            self.canvasView.frame = CGRect.init( x: self.imgView.frame.origin.x, y: self.imgView.frame.origin.y, width: self.imgView.frame.width, height: self.imgView.frame.height)
        }
    }
